...
// clang-format off
#define CommonHeader \
     uint8_t marked; uint8_t tt; uint8_t memcat // marked = 0x0, tt = 0x1, memcat = 0x2
// clang-format on
...
typedef struct Proto
{
    ...
    PROTO_USERDATA_ENC<void*> userdata; // 0x28
    const Instruction* codeentry; // 0x30
    PROTO_LOCVARS_ENC<struct LocVar*> locvars; // 0x38
    void* execdata; // 0x40
    uintptr_t exectarget; // 0x48
    ...
    PROTO_LINEINFO_ENC<uint8_t*> lineinfo; // 0x78
    PROTO_SOURCE_ENC<TString*> source; // 0x80
